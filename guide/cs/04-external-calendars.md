...
| | Google Kalendář | Apple Kalendář |
|---|---|---|
| Jak se připojuje | Přihlášením k účtu Google | Udělením přístupu ke kalendáři na tomto zařízení |
| Účty | **Několik naráz** — pracovní i osobní vedle sebe | Kalendáře, které už máte nastavené na iPhonu |
| Čtení událostí | Ano | Ano |
| Úpravy, mazání | Ano | Ano |
| Vytváření nových událostí | Ne — vytvářejte je ve vlastním kalendáři aplikace | Ne — vytvářejte je ve vlastním kalendáři aplikace |
| Kde data zůstávají | Ve vašem účtu Google | Ve vašem zařízení |
...
Klepněte na **Připojit** u Google Kalendáře a přihlaste se. Můžete to zopakovat pro tolik účtů Google, kolik jich používáte — každý se připojuje zvlášť a v seznamu kalendářů je u každého vidět, kterému účtu patří.
...
### Práce s událostí z Google Kalendáře
...
**Odpojit** můžete kdykoli na téže obrazovce nastavení. Vašich vlastních událostí se to nedotkne a z účtu Google se nic nesmaže — kalendáře se prostě přestanou zobrazovat.
...
Klepněte na **Připojit** u Apple Kalendáře a povolte přístup ke kalendáři. Žádné zvláštní přihlašování není potřeba: aplikace čte kalendáře, které už máte nastavené v iOS, ať pocházejí z jakýchkoli účtů.

Pokud byl přístup dřív odepřen, aplikace vás nasměruje do Nastavení iOS. Na spravovaných zařízeních, kde je přístup ke kalendáři omezený, vám to aplikace řekne, místo aby selhala.
...
## Jak se externí události chovají
...
[← Obsah](./README.md) · [Další: Přizpůsobení a nastavení →](./05-personalization.md)

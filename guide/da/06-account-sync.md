...
## Hvad et login giver dig

Log ind med **Google** eller **Apple**, og du får desuden:

- **Sikkerhedskopi** – dine begivenheder ligger i din konto, ikke kun på denne telefon
- **Synkronisering på tværs af enheder** – den samme kalender på hver iOS-enhed, du er logget ind på
- **[AI-hurtigindtastning](./02-ai-input.md)** – den ene funktion, der kræver en konto, fordi anmodningen kører på en server
...
## Sådan styrer du din konto

Under **Indstillinger › Konto** kan du se, hvordan du loggede ind, hvilken e-mail der er knyttet til kontoen, og hvornår du sidst loggede ind.

- **Log ud** – appen går tilbage til offlinetilstand og kører videre med lokale data.
- **Slet konto** – fjerner din konto og dens data. Det kan ikke fortrydes, og appen beder dig bekræfte, inden den går i gang.

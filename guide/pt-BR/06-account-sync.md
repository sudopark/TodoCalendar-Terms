...
## Os eventos que você já criou

Se você vinha usando o app sem conta, fazer login não deixa esse trabalho para trás. Tudo o que você criou antes é **migrado para a sua conta automaticamente** — primeiro os tipos de evento, depois as tarefas, os compromissos, os detalhes dos eventos e as tarefas concluídas — e o app informa quantos eventos está movendo e quando termina.

Você não precisa fazer nada, e nada é excluído no caminho.
...
Em **Ajustes › Conta** você vê como fez o login, o e-mail vinculado à conta e quando entrou pela última vez.

- **Sair** — o app volta ao modo offline e continua funcionando com os dados locais.
- **Excluir Conta** — remove sua conta e os dados dela. Isso não pode ser desfeito, e o app pede confirmação antes de seguir em frente.

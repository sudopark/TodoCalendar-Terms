...
Da **Impostazioni › Account** puoi vedere con quale metodo hai effettuato l'accesso, l'email collegata all'account e quando hai effettuato l'ultimo accesso.

- **Esci** — l'app torna in modalità offline e continua a funzionare con i dati locali.
- **Elimina account** — rimuove il tuo account e i suoi dati. Non si può annullare, e l'app ti chiede una conferma prima di procedere.

...
## Mit kapcsolhat össze

| | Google Naptár | Apple Naptár |
|---|---|---|
| Hogyan kapcsolódik | Bejelentkezés a Google-fiókjába | Naptár-hozzáférés engedélyezése ezen az eszközön |
| Fiókok | **Több egyszerre** — a munkahelyi és a személyes egymás mellett | Az iPhone-ján már beállított naptárak |
| Események olvasása | Igen | Igen |
| Szerkesztés, törlés | Igen | Igen |
| Új események létrehozása | Nem — hozza létre őket az alkalmazás saját naptárában | Nem — hozza létre őket az alkalmazás saját naptárában |
| Hol vannak az adatok | A Google-fiókjában maradnak | Az eszközén maradnak |
...
Koppintson a Google Naptár melletti **Csatlakoztatás** gombra, és jelentkezzen be. Ezt annyi Google-fiókkal megismételheti, ahányat használ — mindegyik külön csatlakozik, és mindegyik megmutatja a naptárlistában, melyik fiókhoz tartozik.
...
Bármikor **leválaszthat** ugyanazon a beállítási képernyőn. A saját eseményei érintetlenek maradnak, és a Google-fiókjából sem törlődik semmi — a naptárak egyszerűen nem jelennek meg többé.
...
Koppintson az Apple Naptár melletti **Csatlakoztatás** gombra, és engedélyezze a naptár-hozzáférést. Nincs külön bejelentkezés: az alkalmazás az iOS-ben már beállított naptárakat olvassa, bármilyen fiókból származzanak is.

Ha korábban megtagadta a hozzáférést, az alkalmazás elirányítja az iOS Beállításokhoz. Felügyelt eszközön, ahol a naptár-hozzáférés korlátozott, az alkalmazás ezt közli, ahelyett hogy elbukna.
...
## Hogyan viselkednek a külső események
...
[← Tartalom](./README.md) · [Következő: Személyre szabás és beállítások →](./05-personalization.md)
